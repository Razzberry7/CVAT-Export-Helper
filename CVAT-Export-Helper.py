...
def export_helper(path):
    if path != "":
        ...
        # zf = ZipFile(path_origin + filename + ".zip", "w")
        # for dirname, subdirs, files in os.walk(path_origin + filename):
        #     # zf.write(dirname)
        #     for filename in files:
        #         zf.write(os.path.join(dirname, filename),
        #                  os.path.relpath(os.path.join(dirname, filename),
        #                                  os.path.join(path_origin + filename, '..')))
        # zf.close()
...
# class_settings_bush_cb = Radiobutton(scp_settings_frame,
#                                      text="Using bush classes",
#                                      variable=scp_settings_var,
#                                      fg=text_color, bg=outline_color,
#                                      value="Bush")
# class_settings_bush_cb.pack(side=LEFT)
#
# class_settings_scorch_cb = Radiobutton(scp_settings_frame,
#                                        text="Using scorch classes",
#                                        variable=scp_settings_var,
#                                        fg=text_color, bg=outline_color,
#                                        value="Scorch")
